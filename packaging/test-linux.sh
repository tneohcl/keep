...
python3 -m unittest -v test_applications test_theming test_mount_service test_app_logging test_restore_copy test_backup_locking test_cli test_destination_mounts test_vendor test_recovery_test test_review_fixes test_pr3_followups
